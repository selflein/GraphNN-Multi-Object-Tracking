...
def get_dataloader(split_path: str = "data/MOT16/train"):
    dataset_test = MOT16ObjDetect(split_path, obj_detect_transforms(train=False))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path", type=str, help="Path to the FasterRCNN " "model"
    )
    parser.add_argument(
        "--dataset_path",
        type=str,
        default="data/MOT16/train",
    ...
    parser.add_argument(
        "--out_path",
        type=str,
        help="Output directory of the .txt files with " "detections",
    )
